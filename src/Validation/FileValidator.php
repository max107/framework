    ...
    public function validate($value)
    {
        ...
        if (is_array($value)) {
            ...
            if (
                ...
                $this->addError(app()->t('validation', $this->codeToMessage($value['error'])));
            }

            if ($this->maxSize !== null && $value['size'] > $this->maxSize) {
                $this->addError(app()->t('validation', 'Maximum uploaded file size: {size}', [
                    '{size}' => $this->maxSize
                ]));
            }
        }
        ...
        if (
            ...
            $this->addError(app()->t('validation', "Is not a valid file type {type}. Types allowed: {allowed}", [
                '{type}' => $ext,
