...
/**
 * BaseList implements an integer-indexed collection class.
 *
 ...
 * BaseList can also be used like a regular array as follows,
 * <pre>
 ...
 * </pre>
 *
 * To extend BaseList by doing additional operations with each addition or removal
...
class BaseList implements IteratorAggregate, ArrayAccess, Countable
{
    ...
    {
        return new BaseListIterator($this->_d);
    }
