...
namespace Mindy\Query\Database\Pgsql;
...
EOD;
    ...
    {
        $tableName = $this->getAdapter()->quoteValue($table->name);
        $tableSchema = $this->getAdapter()->quoteValue($table->schemaName);
...
SQL;
        $constraints = $this->getDb()->createCommand($sql)->queryAll();
...
SQL;
    ...
    {
        $tableName = $this->getAdapter()->quoteValue($table->name);
        $schemaName = $this->getAdapter()->quoteValue($table->schemaName);
        $sql = <<<SQL
SELECT
